...
\startdescription{2016-现在}
  {\bf 硕士, 材料物理与化学}; 中国科技大学(中科院金属所)

  {\em 主要课题：高压下UH合金的第一性原理计算}

  {\em 主要课程：材料物理、材料化学、数值方法、数理方程、学位英语}
\stopdescription

\startdescription{2012-2016}
  {\bf 本科，材料成型及控制工程(焊接)}; 河南科技大学

  {\em 毕业论文：10t-19.5m桥式起重机桁架梁主桁架结构及工艺设计}

  {\em 主要课程：大学英语、高等数学，线性代数、概率统计、C语言程序设计、工程制图、
  大学物理、机械设计、电工电子技术、材料科学基础、材料成型原理、焊接结构、材料焊接性、
  弧焊电源、压力焊、电弧焊与电渣焊}
\stopdescription

\subsection[title={实习经历},reference={实习经历}]
...
\subsection[title={技能证书},reference={技能证书}]
